          ...
          >
            <div className="relative flex-1 min-w-60 max-md:min-w-full max-md:w-full">
              ...
              <input
                ...
                className="w-full bg-[rgba(31,31,31,1)] border border-[rgba(255,255,255,0.05)] focus:border-[rgba(255,255,255,0.2)] min-h-[52px] max-md:min-h-[48px] overflow-hidden pl-12 max-md:pl-10 pr-4 max-md:pr-3 py-[21px] max-md:py-[18px] rounded-3xl max-md:rounded-2xl transition-all duration-200 focus:outline-none text-sm max-md:text-xs"
              />
            </div>
            <motion.button
              type="submit"
              className="self-stretch bg-[rgba(31,31,31,1)] hover:bg-[rgba(41,41,41,1)] border border-[rgba(255,255,255,0.05)] hover:border-[rgba(255,255,255,0.1)] min-h-[52px] max-md:min-h-[48px] overflow-hidden w-[146px] max-md:w-full max-md:min-w-[120px] px-[18px] max-md:px-4 py-[21px] max-md:py-[18px] rounded-3xl max-md:rounded-2xl transition-all duration-200 flex items-center justify-center gap-2 group text-sm max-md:text-xs"
